...
promo_page_link = "http://selenium1py.pythonanywhere.com/catalogue/coders-at-work_207/?promo=newYear2019"
...
class TestUserAddToCartFromProductPage(object):
    ...
    def setup(self, browser):
        ...
        login_page.register_new_user(login_page.get_email(), login_page.get_password())
